...
a.out: main.o user.o publisher.o comment.o network.o command_handler.o film.o user_repository.o film_repository.o comment_repository.o exception.o notification.o validity.o
	$(CC) main.o user.o publisher.o comment.o network.o command_handler.o film.o user_repository.o film_repository.o comment_repository.o exception.o notification.o validity.o -o a.out
...
user.o: user.cpp user.h notification.h film.h user_repository.h
